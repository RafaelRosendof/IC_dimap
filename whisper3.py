...
common_voice["train"] = load_dataset("mozilla-foundation/common_voice_11_0", "pt", split="train+validation")#Aqui tbm vai um argumeto de token
common_voice["test"] = load_dataset("mozilla-foundation/common_voice_11_0", "pt", split="test")#Pode colocar o token aqui
...
if torch.cuda.device_count() > 1:
    ...
    model = nn.DataParallel(model) #coloque device_ids=[0,1,2] caso de alguma merda 
...
training_args = Seq2SeqTrainingArguments(
    output_dir="./whisper_teste",  # change to a repo name of your choice

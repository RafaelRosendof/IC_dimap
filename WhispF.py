...
token = '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'
...
training_args = Seq2SeqTrainingArguments(
    output_dir="./whisper-large-pt",  # change to a repo name of your choice
...
kwargs = {
    ...
    "language": "lt",
    "model_name": "Whisper L",  # a 'pretty' name for our model
